...
//             <div
//               key={toast.id}
//               className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-glow backdrop-blur-sm border animate-in slide-in-from-top duration-300 ${
//                 toast.type === "success"
//                   ? "bg-primary/10 border-primary/30 text-primary"
//                   : toast.type === "error"
//                     ? "bg-destructive/10 border-destructive/30 text-destructive"
...
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//               className="w-full pl-12 pr-4 py-3 bg-input border border-border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-smooth"
//             />
//           </div>
//         </div>
...
//                 <div
//                   key={note.id}
//                   className="gradient-card rounded-2xl p-6 border border-border shadow-card hover:shadow-glow transition-all duration-300"
//                 >
...
//                   <button
//                     onClick={() => setShowAddNote(true)}
//                     className="px-6 py-3 gradient-hero text-primary-foreground rounded-xl font-semibold hover-glow transition-smooth inline-flex items-center gap-2"
//                   >
//                     <Plus className="w-5 h-5" />
//                     Add First Note
//                   </button>
...
//         {showDeleteConfirm && noteToDelete && (
//           <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
//             <div className="gradient-card rounded-2xl border border-border shadow-glow w-full max-w-md animate-in zoom-in-95 duration-200">
//               <div className="p-6">
//                 <div className="w-14 h-14 rounded-full bg-destructive/10 mx-auto mb-4 flex items-center justify-center">
...
//                       setNoteToDelete(null);
//                     }}
//                     className="flex-1 px-6 py-3 bg-muted text-foreground rounded-xl font-semibold hover:bg-muted/80 transition-smooth"
//                   >
//                     Cancel
//                   </button>
//                   <button
//                     onClick={handleDeleteNote}
//                     className="flex-1 px-6 py-3 bg-destructive text-destructive-foreground rounded-xl font-semibold hover:bg-destructive/90 transition-smooth"
//                   >
//                     Delete
//                   </button>
//                 </div>
...
//         {showAddNote && (
//           <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
//             <div className="gradient-card rounded-2xl border border-border shadow-glow w-full max-w-2xl max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200">
//               {/* Header - Fixed */}
...
//                       Document your observation or feedback
//                     </p>
//                   </div>
//                 </div>
//                 <button
...
//                     onChange={handleInputChange}
//                     placeholder="Brief summary of the note"
//                     className={`w-full px-4 py-3 bg-input border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-smooth ${
//                       formErrors.title
//                         ? "border-destructive focus:ring-destructive"
//                         : "border-border focus:ring-ring"
//                     }`}
...
//                     placeholder="Detailed description of the issue, observation, or feedback..."
//                     rows="8"
//                     className={`w-full px-4 py-3 bg-input border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 transition-smooth resize-none ${
//                       formErrors.description
//                         ? "border-destructive focus:ring-destructive"
//                         : "border-border focus:ring-ring"
//                     }`}
...
//                   type="button"
//                   onClick={handleSubmit}
//                   className="flex-1 px-6 py-3 gradient-hero text-primary-foreground rounded-xl font-semibold hover-glow hover-scale transition-smooth"
//                 >
//                   Add Note
//                 </button>
//               </div>
...
//         {/* View Note Modal - Enhanced */}
//         {showViewNote && selectedNote && (
//           <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
//             <div className="gradient-card rounded-2xl border border-border shadow-glow w-full max-w-3xl max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200">
//               {/* Header - Fixed */}
...
//                 <button
//                   onClick={() => setShowViewNote(false)}
//                   className="text-muted-foreground hover:text-foreground transition-smooth p-2 rounded-lg hover:bg-muted flex-shrink-0"
//                 >
//                   <X className="w-6 h-6" />
//                 </button>
//               </div>
...
//                   }}
//                   className="flex-1 px-6 py-3 bg-destructive/10 hover:bg-destructive/20 text-destructive rounded-xl font-semibold transition-smooth flex items-center justify-center gap-2"
//                 >
...
//                         <div className="flex items-center gap-2">
//                           <User className="w-4 h-4" />
//                           <span className="font-medium truncate max-w-[120px]">{note.author}</span>
//                         </div>
//                         <div className="flex items-center gap-2">
//                           <Calendar className="w-4 h-4" />
//                           <span>
...
//                     "{noteToDelete.title.length > 50
//                       ? noteToDelete.title.slice(0, 50) + '...'
//                       : noteToDelete.title}"
//                   </span>
//                   ? This action cannot be undone.
//                 </p>
...
//                     <div className="flex items-center gap-2">
//                       <User className="w-4 h-4 flex-shrink-0" />
//                       <span className="font-medium truncate max-w-[150px]">{selectedNote.author}</span>
//                     </div>
...
// export default Maintenance;play play
import React, { useState } from "react";
import {
  FileText,
  Plus,
